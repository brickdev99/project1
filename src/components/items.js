...
const images = [
  "https://images.usc.co.uk/images/products/42740802_3pl.jpg",
  "https://i.pinimg.com/originals/d8/f3/8b/d8f38be29b1f574e5deec5267d14ae12.jpg",
  "https://static.ajkerdeal.com/images/deals/01803120359/smallimage1.jpg",
  "https://qph.fs.quoracdn.net/main-qimg-372eefa9e10f713e209af7b1f97aa154-c",
  "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQQQv-8AjXLAHnIlQZIGXRQXqDJ6RV6kqrztQAmxk9VbxjVHBlS",
  "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQQQv-8AjXLAHnIlQZIGXRQXqDJ6RV6kqrztQAmxk9VbxjVHBlS",
];
    ...
    var data = datas.map((d, i) => {
      return (
        <div
          key={i}
          className="col-sm-4"
          onMouseEnter={() => this.addOption(i)}
          onMouseLeave={() => this.addOption1(i)}
        >
          <div className={"data-" + i + " " + "hello"}>
            <span className={"tag" + " " + "span" + i}>
              <span className="cart-text" onClick={() => this.addToCart(i)}>
                Add to Cart
              </span>
            </span>
